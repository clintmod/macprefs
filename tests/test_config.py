...
def test_get_preferences_dir():
    assert config.get_preferences_dir() == path.join(config.get_home_dir(), "Library/Preferences/")
...
def test_get_ssh_user_dir():
    assert config.get_ssh_user_dir() == path.join(config.get_home_dir(), ".ssh/")
...
def test_get_app_store_preferences_dir():
    assert config.get_app_store_preferences_dir() == path.join(config.get_home_dir(), "Library/Containers/")
