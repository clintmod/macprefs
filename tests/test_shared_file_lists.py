...
def test_backup_works(copy_dir_mock):
    ...
    copy_dir_mock.assert_called_with(config.get_shared_file_lists_dir(), config.get_shared_file_lists_backup_dir())
...
def test_restore_works(copy_dir_mock, owned_mock):
    ...
    copy_dir_mock.assert_called_with(
        config.get_shared_file_lists_backup_dir(), config.get_shared_file_lists_dir(), with_sudo=True
    )
